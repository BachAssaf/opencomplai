...
The public docs-widget checker routes (``checker_routes.router``) are
deliberately NOT gated by this dependency — they are meant to be called
directly from an anonymous browser and are protected by CORS + per-IP rate
limiting instead.
"""
